...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed bottom-5 right-3.5 z-20 inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/15 bg-[linear-gradient(135deg,rgba(245,199,107,0.94),rgba(14,165,233,0.9))] p-0 text-sm font-semibold text-brand-black shadow-[0_10px_22px_rgba(14,165,233,0.14)] transition-all duration-200 hover:translate-y-[-1px] hover:shadow-[0_14px_28px_rgba(245,199,107,0.18)] sm:bottom-8 sm:right-5 sm:h-auto sm:w-auto sm:gap-2 sm:px-3.1 sm:py-2.15 lg:bottom-10 lg:right-10 lg:px-3 lg:py-2 xl:bottom-10 xl:right-10 xl:gap-2.5 xl:px-3.4 xl:py-2.3"
    >
